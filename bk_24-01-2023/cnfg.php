                ...
                <div id="cfg-options" class="cfg-options">
                    <div class="step" id="step__0" btn="">
                        ...
                        <div class="cfg-model-wrapper">
                            <div data-variable-name="model" data-variable-value="1" data-active="true" data-model="1" data-price="67800" class="cfg-model active" id="cfg-firstmodel" onclick='cfgDoorModel1()'>
                            ...
                            <div data-variable-name="model" data-variable-value="2" data-active="false" data-model="2" data-price="79400" class="cfg-model" id="cfg-secondmodel" onclick='cfgDoorModel2()'>
                                    ...
                                    <div class="accordion-content">
                                        <div class="tabs-group" withoutscroll="true">
                                            <div class="tabs-group-item tabs-2">
                                                <div data-variable-name="leaf" data-variable-value="single" data-active="true" data-leaf="single" data-price="0" class="tab active tab-2" id="singleleafdoorbutton"
                                                    onclick="singleleaf()">Одностворчатая</div>
                                                <div data-variable-name="leaf" data-variable-value="double" data-active="false" data-leaf="double" data-price="0" class="tab tab-2" id="doubleleafdoorbutton" onclick="doubleleaf()">
                                                    Двустворчатая</div>
                                            </div>
                                            ...
                                            <div class="tabs-group-body">
                                                <div>
                                                    <div class="furniture-group construction-body single-leaf active"
                                                        id="singleleafdoor">
                                                        <div data-variable-name="leafdooritems_single" data-variable-value="slditem1" data-active="true" data-leafdooritems="slditem1" data-price="0" class="furniture-item active furniture-item--big"
                                                            id="slditem1" onclick="leafdooritems('slditem1')">
                                                        ...
                                                        <div data-variable-name="leafdooritems_single" data-variable-value="slditem2" data-active="false" data-leafdooritems="slditem2" data-price="0" class="furniture-item furniture-item--big" id="slditem2" onclick="leafdooritems('slditem2')">
                                                            <div class="furniture-item-image-cover">
                                                                <span class="furniture-item-image-country"></span>
                                                                <div class="furniture-item-image"
                                                        ...
                                                        <div data-variable-name="leafdooritems_single" data-variable-value="slditem3" data-active="false" data-leafdooritems="slditem3" data-price="0" class="furniture-item furniture-item--big" id="slditem3" onclick="leafdooritems('slditem3')">
                                                            <div class="furniture-item-image-cover">
                                                                <span class="furniture-item-image-country"></span>
                                                                <div class="furniture-item-image"
                                                    ...
                                                    <div class="furniture-group construction-body double-leaf"
                                                        id="doubleleafdoor" style="display: none;">
                                                        <div data-variable-name="leafdooritems_double" data-variable-value="dlditem1" data-active="true" data-leafdooritems="dlditem1" data-price="0" class="furniture-item active furniture-item--big"
                                                            id="dlditem1" onclick="leafdooritems('dlditem1')">
                                                            <div class="furniture-item-image-cover">
                                                                <span class="furniture-item-image-country"></span>
                                                                <div class="furniture-item-image"
                                                                    style="background-image: url(&quot;https://portalle.ru/storage/cfg-door-extend-constructs/343ba830d85ef96d6906054578432adf.svg&quot;);">
                                                                </div>
                                                            </div>
                                                            <div class="furniture-item-title">Тип I</div>
                                                            <div class="furniture-item-title">Базовое</div>
                                                        </div>
                                                        <div data-variable-name="leafdooritems_double" data-variable-value="dlditem2" data-active="false" data-leafdooritems="dlditem2" data-price="0" class="furniture-item furniture-item--big" id="dlditem2"
                                                            onclick="leafdooritems('dlditem2')">
                                                            
                                                            <div class="furniture-item-image-cover">
                                                                <span class="furniture-item-image-country"></span>
                                                                <div class="furniture-item-image"
                                                                    style="background-image: url(&quot;https://portalle.ru/storage/cfg-door-extend-constructs/6bb08739bd932f0e430104985ec6a7d8.svg&quot;);">
                                                                </div>
                                                            </div>
                                                            <div class="furniture-item-title">Тип II</div>
                                                            <div class="furniture-item-title">Базовое</div>
                                                        </div>
                                                        <div data-variable-name="leafdooritems_double" data-variable-value="dlditem3" data-active="false" data-leafdooritems="dlditem3" data-price="0" class="furniture-item furniture-item--big" id="dlditem3"
                                                            onclick="leafdooritems('dlditem3')">
                                                            
                                                            <div class="furniture-item-image-cover">
                                                                <span class="furniture-item-image-country"></span>
                                                                <div class="furniture-item-image"
                                                                    style="background-image: url(&quot;https://portalle.ru/storage/cfg-door-extend-constructs/8058b51d1a6bc2d5f60a3aedc14d8bc4.png&quot;);">
                                                                </div>
                                                            </div>
                                                            <div class="furniture-item-title">Тип III</div>
                                                            <div class="furniture-item-title">Базовое</div>
