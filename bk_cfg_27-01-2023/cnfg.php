            ...
            <div class="cfg-body">
                ...
                <div id="cfg-options" class="cfg-options">
                    ...
                    <div class="step" id="step__1" btn="">
                        ...
                        <div data-variable-name="furniture_extra-grid1_check" data-variable-value="1" data-furniture_extra-grid1_check="1" data-price="0" class="checkbox-accordion accordion accordion--with-plus colored" id="checkbox-1step-extra-grid" <?=((isset($_GET['leafdooritems_single']) AND ($_GET['leafdooritems_single'] == 'slditem2' OR $_GET['leafdooritems_single'] == 'slditem3')) OR (isset($_GET['leafdooritems_double']) AND ($_GET['leafdooritems_double'] == 'dlditem2' OR $_GET['leafdooritems_double'] == 'dlditem3'))) ? '' : 'style="display: none;"'?>>
                                ...
                                <div class="accordion-body">
                                    <div class="accordion-content">
                                        <div class="furniture-color furniture-color-circle">
                                            ...
                                            <div class="texture-group">
                                                <div data-variable-name="furniturecol" data-variable-value="furn-col-1" data-furniturecol="furn-col-1" data-price="0" class="texture-item<?=((isset($_GET['furniturecol']) AND $_GET['furniturecol'] == 'furn-col-1') OR !isset($_GET['furniturecol'])) ? ' active' : ''?>" id="furn-col-1"
                                    ...
                                    <div class="accordion-content">
                                        <div class="cfg-option-group" items="">
                                            ...
                                            <div class="cfg-btn-group-wrapper side-items">
                                                ...
                                                <button data-variable-name="furnitem_side" data-variable-value="side-item2-step_6" data-furnitem_side="side-item2-step_6" data-price="0" type="button" lass="cfg-btn btn btn-normal btn-gradient-primary<?=(isset($_GET['furnitem_side']) AND $_GET['furnitem_side'] == 'side-item2-step_6') ? ' active' : ''?>" id="side-item2" onclick="furnItem('side-item2', '#step__6 .side-items .btn-gradient-primary')">
                                                    <span>
                                                        <em>Левая</em>
                                                    </span>
                                                </button>
