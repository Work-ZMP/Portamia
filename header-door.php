...
<body>
    ...
    <main class="slideout-panel panel-main" id="panel">
        <header class="header">
            ...
            <div class="header__slider header-door">
                <div class="swiper-wrapper">
                    <div class="header__slide slide-1 swiper-slide">
                    <img src="<?php the_field('header-img') ?>" alt="" class="header__slide-cover-img">
                        <div class="header__slide-text">
                            <div class="header__slide-subtitle">дверь</div>
                            <h1 class="header__slide-title"><?php the_field('door-name') ?></h1>
                        </div>
                    </div>
                </div>
