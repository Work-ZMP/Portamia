        ...
        <head>
            ...
            <style>
                ...
                section {
                    ...
                    border: 3px solid black;
                    margin: 20px auto;
                    background: url("https://portamia.ru/wp-content/uploads/2023/01/background-pdf.png");
        ...
        <body>
            <section class="external-side">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr class="header">
                        <th><img src="https://portamia.ru/wp-content/uploads/2023/01/cropped-Logo.png"
                                class="pdf__logo"></th>
                        <th class="pdf__number">+7(961)949-48-48</th>
                    </tr>
                    <tr class="title">
                        <th colspan="2">Ваша идеальная дверь</th>
                    </tr>
                    <tr class="descr">
                        <th colspan="2">Внешняя сторона</th>
                    </tr>
                    <tr class="door door-external-side">
                        <th colspan="2"><img src="<?=$outdoor?>"></th>
                    </tr>
                </table>
            </section>
            <section class="inner-side">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr class="header">
                        <th><img src="https://portamia.ru/wp-content/uploads/2023/01/cropped-Logo.png" class="pdf__logo"></th>
                        <th class="pdf__number">+7(961)949-48-48</th>
                    </tr>
                    <tr class="title">
                        <th colspan="2">Ваша идеальная дверь</th>
                    ...
                    <tr class="descr">
                        <th colspan="2">Внутренняя сторона</th>
                    </tr>
                    <tr class="door door-inner-side">
                        <th colspan="2"><img src="<?=$indoor?>"></th>
                    </tr>
                </table>
            </section>
            <section class="cheque-1">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="cheque-title__block">
                        <th class="cheque-title">Чек двери</th>
                        <th class="page1">Страница 1</th>
                    </tr>
            ...
            <section class="cheque-2">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr class="cheque__total">
                        <th rowspan="6" class="cheque__total-img">
                            <div class="cheque__total-img-inner">
                                <img src="<?=$outdoor?>">
                                <img src="<?=$indoor?>">
                            </div>
                        </th>
