        ...
        <section class="external-side">
            <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                <tr class="header" style="width:100%;">
                    <th style="text-align:left;width:50%;padding-bottom: 20px"><img style="margin-top:10px"
                            src="https://portamia.ru/lpt.png" class="pdf__logo"></th>
                    <th style="font-family: Raleway;text-align:right;width:50%;padding-bottom: 20px" class="pdf__number">
                        +7(961)949-48-48</th>
                </tr>
                <tr class="title" style="">
                    <th style="font-size:35px;padding-top:40px;font-weight: 600; font-family: Raleway" colspan="2">Ваша
                        идеальная дверь</th>
                </tr>
                <tr class="descr">
        ...
        <section class="cheque-1" style="font-family : Raleway">
            <table border="0" cellpadding="0" cellspacing="0" style="font-family : Raleway">
                ...
                <tr class="cheque-title__block">
                    <th style="text-align:left;width:50%;padding-left: 0px;color:#000;padding-top: 10px"
                        class="cheque-title">Чек двери</th>
                    <th style="text-align:right;width:50%;padding-right: 0px;color:rgba(0, 0, 0, 0.50);padding-top: 10px"
                        class="page1">Страница 1</th>
                </tr>
                        ...
                        <table class="table-transparent">
                            ...
                            <?php if ($door_cfg['model']['value'] == 1): ?>
                                ...
                                <tr>
                                    ...
                                    <th class="cheque__table-cost"
                                        style="font-variant-numeric: lining-nums proportional-nums; ">
                                        <?= $door_cfg['model']['price'] ?> ₽123456780
                                    </th>
                                </tr>
                                <tr>
                            ...
                            <?php if ($door_cfg['model']['value'] == 2): ?>
                                ...
                                <tr>
                                    <th class="cheque__table-name">База</th>
                                    <th class="cheque__table-cost"
                                        style="font-variant-numeric: lining-nums proportional-nums; font-family: Raleway">
                                        <?= $door_cfg['model']['price'] ?> ₽
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <?php if (isset($door_cfg['furniture_extra-grid1_check']['value']) and $door_cfg['furniture_extra-grid1_check']['value'] == 1): ?>
                                    ...
                                    <?php if ($door_cfg['furnitem_extra-grid1']['value'] == 'extra-grid-step1-item5-step__1'): ?>
                                        ...
                                        <?php if (!empty($door_cfg['furnitem_extra-grid1']['price'])): ?>
                                            <tr>
                                                <th class="cheque__table-name">Дополнительная секция</th>
                                                <th class="cheque__table-cost"><?= $door_cfg['furnitem_extra-grid1d']['price'] . ' ₽' ?>
                                                </th>
                                            </tr>
                                        <?php else: ?>
                                            <tr>
                            ...
                            <?php if ($door_cfg['furnituredoorsteptype']['value'] == 'doorstep-item1'): ?>
                                ...
                                <?php if (!empty($door_cfg['furnituredoorsteptype']['price'])): ?>
                                    <tr>
                                        ...
                                        <th class="cheque__table-cost"><?= $door_cfg['furnituredoorsteptype']['price'] . ' ₽' ?>
                                        </th>
                                    </tr>
                                <?php else: ?>
                                    <tr>
        ...
        <section id="lolo" class="cheque-2">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="font-family : Raleway">
                <tr class="header" style="width:100%;border: 0">
                    <th style="text-align:left;width:50%;padding-bottom: 20px"><img style="margin-top:10px"
                            src="https://portamia.ru/lpt.png" class="pdf__logo"></th>
                    <th style="text-align:right;width:50%;padding-bottom: 20px;border-bottom:1px solid #000000;color:#000000;opacity: 1"
                        class="pdf__number">+7(961)949-48-48</th>
                </tr>
                <tr class="cheque-title__block">
                    <th style="text-align:left;width:50%;padding-left: 0px;color:#000;padding-top: 20px"
                        class="cheque-title">Чек двери</th>
                    <th style="text-align:right;width:50%;padding-right: 0px;padding-top: 20px" class="page1">Страница 2
                    </th>
                </tr>
            </table>
            <div class="mtttop" style="margin-top:100px">
                <table border="0" cellpadding="0" cellspacing="0" style="font-family : Raleway">
                    ...
                    <tr class="cheque__total">
                        ...
                        <th class="cheque__total-old-cost"
                            style="font-variant-numeric: lining-nums proportional-nums; font-family: Raleway">
                            <?= $total_cost_old ?> ₽
                        </th>
                    ...
                    <tr class="cheque__total">
                        <th class="cheque__total-current-cost"
                            style="font-variant-numeric: lining-nums proportional-nums; font-family: Raleway ">
                            <?= $total_cost ?> ₽
                        </th>
                    </tr>
                    ...
                    <tr class="cheque__total imotr">
                        <td style="padding-top: 40px;vertical-align: top;padding-left:25px; width: 230px"
                            class="cheque__total-img">
                            <div class="cheque__total-img-inner" style="">
                                <img src="<?= $outdoor ?>">
                                <img src="<?= $indoor ?>">
                            </div>
                        </td>
                        <td style="padding-top: 40px;vertical-align: top;" class="cheque__total-name1"
                            style="font-size:14px;color:#000000">Дата создания двери: <span
                                style="font-size:14px;color:#00000080; font-family: Raleway; font-variant-numeric: lining-nums proportional-nums"><?= date('d.m.Y H:i') ?></span>
