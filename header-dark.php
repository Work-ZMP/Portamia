...
<body>
    ...
    <main class="slideout-panel" id="panel">
        <header class="header header-darkpage">
            <div class="header__top darkpage small">
                <img src="<?php echo the_field('header-img') ?>" class="header__top-img" alt="">
                <div class="header__inner">
                    ...
                    <div class="header__top-lower">
                        ...
                        <div class="header__lower-text">
                            <a href="" class="header__lower-subtitle">Главная</a>
                            <div class="header__lower-title"><?php the_title() ?></div>
                        </div>
